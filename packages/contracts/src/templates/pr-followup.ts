    ...
    },
    {
      ...
      config: {
        ...
        instruction: [
          ...
          '· `limit` 是取数上限。PR 数正好等于它时真实数量可能更多，',
          '  写「至少 N 个」而不是确切数字',
